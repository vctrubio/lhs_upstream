...
import { Barrio, Property } from '#/backend/types'
...
export const useSharedQueryState = () => {
    ...
    const [metrosCuadradrosMinimo, setmetrosCuadradrosMinimo] = useQueryState('metrosMin', { defaultValue: '' });
    const [metrosCuadradrosMaximo, setmetrosCuadradrosMaximo] = useQueryState('metrosMax', { defaultValue: '' });
    ...
    const handleReset = () => {
        ...
        setmetrosCuadradrosMinimo(null);
        setmetrosCuadradrosMaximo(null);
    ...
    useEffect(() => {
        ...
        if (metersSquareValue[0] > metersSquareRange[0]) {
            setmetrosCuadradrosMinimo(metersSquareValue[0].toString());
        } else if (metersSquareValue[0] === metersSquareRange[0] && metrosCuadradrosMinimo) {
            setmetrosCuadradrosMinimo(null);
        }

        if (metersSquareValue[1] < metersSquareRange[1]) {
            setmetrosCuadradrosMaximo(metersSquareValue[1].toString());
        } else if (metersSquareValue[1] === metersSquareRange[1] && metrosCuadradrosMaximo) {
            setmetrosCuadradrosMaximo(null);
        }
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            setMetersSquareValue([
                metrosCuadradrosMinimo ? parseInt(metrosCuadradrosMinimo) : minMetersSquare,
                metrosCuadradrosMaximo ? parseInt(metrosCuadradrosMaximo) : maxMetersSquare
            ]);
    ...
    const hasQueryParams = [
        ...
        metrosCuadradrosMinimo, metrosCuadradrosMaximo,
    ...
    return {
        ...
        metrosCuadradrosMinimo, setmetrosCuadradrosMinimo,
        metrosCuadradrosMaximo, setmetrosCuadradrosMaximo,
